...
#define _TTNSERVER "nam1.cloud.thethings.network"//"router.eu.thethings.network"
...
#define _DESCRIPTION "testgatewayprvaughn2"//"eui-70b3d57ed004a905"			// Name of the gateway
#define _EMAIL "prvaughn2"		// Owner
#define _PLATFORM "ESP32"//"ESP8266"
#define _LAT 42.138437
#define _LON -70.969879
#define _ALT 130								// Altitude
...
#if GATEWAYNODE==1
#define _DEVADDR { 0x26, 0x0C, 0x69, 0x9C }
#define _APPSKEY { 0xD1, 0x3B, 0x59, 0x18, 0x4D, 0x32, 0x57, 0x1D, 0x02, 0xEB, 0x40, 0x76, 0x62, 0x96, 0xDF, 0x98 }
#define _NWKSKEY { 0xBB, 0x1E, 0x57, 0x9E, 0xE6, 0x5F, 0xE7, 0xD5, 0x15, 0x7B, 0x11, 0xF6, 0xC4, 0xC0, 0x78, 0x10 }
